...
import { PenLine, Sparkles, TrendingUp, Shield, Lock, ChevronRight, Menu, X, Sun, Moon } from 'lucide-react';
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] dark:bg-[#0A0A09] text-[#1A1A1A] dark:text-[#F3F3F3] font-sans selection:bg-[#E8DCC4] dark:selection:bg-[#8B7355]/30 selection:text-[#1A1A1A] dark:selection:text-[#F3F3F3] overflow-x-hidden transition-colors duration-300">
      {/* Decorative Gradients */}
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute -top-[20%] -right-[10%] w-[70vw] h-[70vw] rounded-full bg-gradient-to-br from-[#F3E5D8]/40 dark:from-[#8B7355]/15 to-transparent blur-3xl opacity-60 dark:opacity-40 transition-colors duration-300" />
        <div className="absolute top-[40%] -left-[20%] w-[60vw] h-[60vw] rounded-full bg-gradient-to-tr from-[#E5ECE9]/40 dark:from-[#3A4A45]/15 to-transparent blur-3xl opacity-60 dark:opacity-40 transition-colors duration-300" />
      </div>

      {/* Navbar */}
      <nav className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#FAFAF8]/80 dark:bg-[#0A0A09]/80 backdrop-blur-md border-b border-black/5 dark:border-white/5 py-3' : 'bg-transparent py-5'}`}>
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link href="#features" className="text-sm font-medium text-black/60 dark:text-white/60 hover:text-black dark:hover:text-white transition-colors">Features</Link>
            <Link href="#how-it-works" className="text-sm font-medium text-black/60 dark:text-white/60 hover:text-black dark:hover:text-white transition-colors">How It Works</Link>
            <Link href="#privacy" className="text-sm font-medium text-black/60 dark:text-white/60 hover:text-black dark:hover:text-white transition-colors">Privacy</Link>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link href="/login" className="text-sm font-medium text-black/80 dark:text-white/80 hover:text-black dark:hover:text-white transition-colors">Log In</Link>
            <Link href="/signup" className="text-sm font-medium bg-black dark:bg-white text-white dark:text-black px-5 py-2.5 rounded-full hover:bg-black/90 dark:hover:bg-white/90 transition-colors shadow-lg shadow-black/10 dark:shadow-none">
              Start Journaling
            </Link>
          </div>
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-[#FAFAF8] dark:bg-[#0A0A09] pt-24 px-6 flex flex-col gap-6 md:hidden text-black dark:text-white transition-colors duration-300">
          ...
          <Link href="/signup" onClick={() => setMobileMenuOpen(false)} className="text-xl font-medium text-[#8B7355] dark:text-[#E8DCC4]">Start Journaling</Link>
        </div>
      )}
      ...
      <section className="relative z-10 pt-40 pb-20 md:pt-48 md:pb-32 px-6 md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 text-center md:text-left">
          <motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-6">
            ...
            <motion.p variants={fadeIn} className="text-lg md:text-xl text-black/60 dark:text-white/60 max-w-xl mx-auto md:mx-0 leading-relaxed">
            ...
            <motion.div variants={fadeIn} className="flex flex-col sm:flex-row items-center gap-4 pt-4 justify-center md:justify-start">
              <Link href="/signup" className="w-full sm:w-auto text-base font-medium bg-black dark:bg-white text-white dark:text-black px-8 py-4 rounded-full hover:bg-black/90 dark:hover:bg-white/90 transition-transform hover:scale-105 active:scale-95 shadow-xl shadow-black/10 dark:shadow-none flex items-center justify-center gap-2">
                Start Journaling <ChevronRight size={18} />
              </Link>
              <Link href="#how-it-works" className="w-full sm:w-auto text-base font-medium text-black/70 dark:text-white/70 hover:text-black dark:hover:text-white px-8 py-4 flex items-center justify-center transition-colors">
                See How It Works
              </Link>
            </motion.div>
          </motion.div>
      ...
      {/* How It Works */}
      <section id="how-it-works" className="relative z-10 py-24 bg-white dark:bg-[#0E0E0D] border-y border-black/5 dark:border-white/5 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <motion.div 
              ...
              className="p-8 rounded-3xl bg-[#FAFAF8] dark:bg-[#151514] border border-black/5 dark:border-white/5 hover:shadow-xl dark:hover:shadow-none transition-shadow duration-300"
            >
              <div className="w-12 h-12 bg-white dark:bg-[#1C1C1B] rounded-2xl flex items-center justify-center shadow-sm mb-6 border border-black/5 dark:border-white/5">
                <PenLine className="text-[#8B7355] dark:text-[#C5B39C]" />
              </div>
            ...
            >
              <div className="w-12 h-12 bg-white dark:bg-[#1C1C1B] rounded-2xl flex items-center justify-center shadow-sm mb-6 border border-black/5 dark:border-white/5">
                <Sparkles className="text-[#8B7355] dark:text-[#C5B39C]" />
              </div>
            ...
            >
              <div className="w-12 h-12 bg-white dark:bg-[#1C1C1B] rounded-2xl flex items-center justify-center shadow-sm mb-6 border border-black/5 dark:border-white/5">
                <TrendingUp className="text-[#8B7355] dark:text-[#C5B39C]" />
              </div>
      ...
      <section className="relative z-10 py-24 md:py-32 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1 w-full">
            ...
            >
              <div className="absolute -top-3 -right-3 w-24 h-24 bg-gradient-to-br from-[#F3E5D8] dark:from-[#8B7355]/10 to-transparent rounded-full blur-2xl opacity-50 z-0" />
          ...
          <div className="flex-1 w-full space-y-6">
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              ...
              <div className="space-y-4">
                <div className="p-5 rounded-2xl bg-white dark:bg-[#121211] border border-black/5 dark:border-white/5 shadow-lg shadow-black/5 dark:shadow-none">
                  <div className="flex items-center gap-2 mb-3">
                    <Sparkles size={16} className="text-[#8B7355] dark:text-[#C5B39C]" />
                ...
                <div className="flex gap-4">
                  <div className="flex-1 p-5 rounded-2xl bg-white dark:bg-[#121211] border border-black/5 dark:border-white/5 shadow-sm">
                    ...
                    <div className="space-y-2">
                      <div>
                        ...
                        <div className="h-1.5 w-full bg-[#FAFAF8] dark:bg-[#1C1C1B] rounded-full overflow-hidden"><div className="h-full bg-black/80 dark:bg-white/80 rounded-full w-[72%]" /></div>
                      </div>
                      <div>
                        <div className="flex justify-between text-xs mb-1"><span>Curiosity</span><span>54%</span></div>
                        <div className="h-1.5 w-full bg-[#FAFAF8] dark:bg-[#1C1C1B] rounded-full overflow-hidden"><div className="h-full bg-[#8B7355] dark:text-[#C5B39C] rounded-full w-[54%]" /></div>
                      </div>
                    </div>
                  </div>
                  <div className="flex-1 p-5 rounded-2xl bg-white dark:bg-[#121211] border border-black/5 dark:border-white/5 shadow-sm">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2.5 py-1 rounded-md bg-[#F3E5D8]/50 dark:bg-[#8B7355]/20 text-[#8B7355] dark:text-[#C5B39C] text-xs font-medium">City</span>
                      <span className="px-2.5 py-1 rounded-md bg-[#E5ECE9]/50 dark:bg-[#3A4A45]/20 text-emerald-700 dark:text-emerald-400 text-xs font-medium">River</span>
                      <span className="px-2.5 py-1 rounded-md bg-black/5 dark:bg-white/5 text-black/60 dark:text-white/60 text-xs font-medium">Running</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="relative z-10 py-24 bg-[#1A1A1A] dark:bg-[#080807] text-white border-y border-black/5 dark:border-white/5 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
      ...
      {/* Privacy */}
      <section id="privacy" className="relative z-10 py-24 bg-white dark:bg-[#0E0E0D] transition-colors duration-300">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <div className="w-16 h-16 bg-[#FAFAF8] dark:bg-[#151514] rounded-full flex items-center justify-center mx-auto mb-6 border border-black/5 dark:border-white/5">
            <Lock className="text-[#8B7355] dark:text-[#C5B39C] w-8 h-8" />
          </div>
      ...
      <section className="relative z-10 py-32 px-6">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-[#FAFAF8] dark:from-[#151514] to-[#F3E5D8]/30 dark:to-[#8B7355]/5 rounded-3xl p-12 md:p-20 text-center border border-black/5 dark:border-white/5 shadow-2xl shadow-[#8B7355]/5 dark:shadow-none transition-colors duration-300">
          ...
          <Link href="/signup" className="inline-block text-lg font-medium bg-black dark:bg-white text-white dark:text-black px-10 py-4 rounded-full hover:bg-black/90 dark:hover:bg-white/90 transition-transform hover:scale-105 active:scale-95 shadow-xl shadow-black/10 dark:shadow-none">
      ...
      {/* Footer */}
      <footer className="relative z-10 py-12 px-6 border-t border-black/5 dark:border-white/5 bg-[#FAFAF8] dark:bg-[#0A0A09] transition-colors duration-300">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="font-display font-medium text-black/60 dark:text-white/60">Dream Journal AI</span>
          </div>
          <div className="flex gap-8 text-sm text-black/50 dark:text-white/50">
          ...
          <p className="text-sm text-black/40 dark:text-white/45">© 2026 Dream Journal AI.</p>
        </div>
      </footer>
    </div>
  );
